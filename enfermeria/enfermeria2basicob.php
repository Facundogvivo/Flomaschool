...
<head>
    ...
    <title>FlomaSchool | Enfermeria 2° basico B</title>
                ...
                <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Enfermeria 2° básico B</strong>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="smallmodalLabel">Enfermería</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    <form action="enfermeria_registro.php" method="POST">
                        <div class="modal-body"> 
                            ...
                            <label for="txt_alumno" class="form-label">Alumno(a)</label>
                                ...
                                <label for="txt_fecha_enfermeria" class="form-label">Fecha</label>
                                <input type="date" class="form-control text-uppercase" id="txt_fecha_enfermeria" name="txt_fecha_enfermeria">
                                    </br>
