...
<head>
    ...
    <title>FlomaSchool | Enfermeria III medio B</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria1basicoa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria1basicob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria2basicoa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria2basicob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria3basicoa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria3basicob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria4basicoa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria4basicob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu5basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria5basicoa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu5basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria5basicob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu6basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria6basicoa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu6basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria6basicob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu7basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria7basicoa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu7basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria7basicob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu8basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria8basicoa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu8basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria8basicob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria1medioa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria1mediob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria2medioa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria2mediob.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria3medioa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria4medioa.php">&#129657; Enfermería</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="enfermeria4mediob.php">&#129657; Enfermería</a></li>
                ...
                <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Enfermeria III medio B</strong>
                            ...
                            <div class="card-body" style="text-align: center;">
                                <table class="table" id="dataTable1" style="text-align: left">
                                    <tr>
                                        ...
                                        <td style="width: 18%" onclick="sortTable(1, 'str')">Nombre</td>
                                        <td style="width: 18%" onclick="sortTable(0, 'str')">Apellido</td>
                                        <td style="width: 18%">Enfermeria</td>
                                    </tr>
                                    <?php
                                    ...
                                    while ($columna = mysqli_fetch_array( $resultadoIIIb ))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $columna['enfermeria'];?></td>
                                        </tr>
                                        <?php
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="smallmodalLabel">Positivas / Negativas</h5>
                    ...
                    <form action="calificacion_registro.php" method="POST">
                        <div class="modal-body"> 
                            ...
                            <label for="txt_alumno" class="form-label">Alumno(a)</label>
                                ...
                                <label for="txt_conducta" class="form-label">Conducta</label>
                                <select class="form-control text-uppercase" id="txt_conducta" name="txt_conducta">
                                    <option value="0" style="display:none;">Seleccionar</option>
                                    <option value="positiva">Positiva</option>
                                    <option value="negativa">Negativa</option>
                                </select>
                                    </br>
                                <label for="txt_fecha_conducta" class="form-label">Fecha</label>
                                <input type="date" class="form-control text-uppercase" id="txt_fecha_conducta" name="txt_fecha_conducta">
                                    </br>
                                <label for="txt_descripcion" class="form-label">Descripción</label>
                                <textarea name="txt_descripcion" id="txt_descripcion" rows="5"></textarea>
