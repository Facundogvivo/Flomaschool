...
<head>
    ...
    <script>
        ...
        function cambiar(){
            ...
            document.getElementById("num").value = globo + 1;
        }
        function cambiarOpcion(){
            document.getElementById("opcion").src = cambia_imagen[document.getElementById("suma").value-1];
        }
        function sumar(){
            a = a + 1;
        ...
        function calcular() {
            ...
            contador++;
            document.getElementById("ejtotales").innerHTML = correctos + incorrectos;
        }
        //----- OPCION 2 -----//
        function cambiarValor(){
            a = 0;
            valorDado = aleatorio(3,8);
            document.getElementById("valorDado").value = valorDado;
            document.getElementById("valor").value = valorDado;
            globo =  aleatorio(0,valorDado -1);
            document.getElementById("ia2").src = cambia_imagen[globo]; 
            document.getElementById("num2").value = globo + 1;
        }            
        function cambiarOpcion2(){
            document.getElementById("opcion22").src = cambia_imagen[document.getElementById("suma2").value-1];
        }
        function sumar2(){
            a = a + 1;
            document.getElementById("res2").value = a;
            document.getElementById("suma2").value = a;
        }
        function restar2(){
            a = a - 1;
            document.getElementById("res2").value = a;
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4>.: Componer y descomponer números :.</h4>
                                </div>
                                <div class="card-body">
                                    <div class="default-tab">
                                        ...
                                        <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="nav-uno" role="tabpanel" aria-labelledby="nav-uno-tab">
                                                <p>Debe completar la cantidad hasta completar una decena.</p>
                                                <table border="0" style="margin: auto;text-align:center;width: 100%;">
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%; padding: 10px;">
                                                            <img src="../../../assets/images/menos.png" id="menos" height="50" style="vertical-align: middle;" onclick="restar(); cambiarOpcion();">
                                                            <input type="text" class="aleatorio casilla" id="res">
                                                            <img src="../../../assets/images/mas.png" id="mas" height="50" style="vertical-align: middle;" onclick="sumar(); cambiarOpcion();">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%; padding: 10px;">
                                                            <img src="../../../assets/images/cuedis.png" id="opcion" height="100">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px;">
                                                            <input type="button" class="boton" value="Calcular" onclick="calcular(); cambiar();">
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <div class="tab-pane fade" id="nav-dos" role="tabpanel" aria-labelledby="nav-dos-tab">
                                                <p>Debe completar la cantidad hasta completar el valor dado.</p>
                                                <table border="0" style="margin: auto;text-align:center;width: 100%;">
                                                    <tr>
                                                        <td style="padding: 10px;">
                                                            <input type="button" class="boton" onclick="cambiarValor();" value="Nuevo">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px;">
                                                            <label>Valor dado</label>
                                                            <input type="text" class="aleatorio" id="valorDado" height="100" width="100">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%; padding: 10px;">
                                                            <img src="../../../assets/images/cuedis.png" id="ia2" height="100">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%; padding: 10px;">
                                                            <img src="../../../assets/images/menos.png" id="menos2" height="50" style="vertical-align: middle;" onclick="restar2(); cambiarOpcion2();">
                                                            <input type="text" class="aleatorio casilla" id="res2">
                                                            <img src="../../../assets/images/mas.png" id="mas2" height="50" style="vertical-align: middle;" onclick="sumar2(); cambiarOpcion2();">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%; padding: 10px;">
                                                            <img src="../../../assets/images/cuedis.png" id="opcion22" height="100">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px;">
                                                            <input type="button" class="boton" value="Calcular" onclick="calcular2(); cambiarValor();">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <input type="text" id="valor" style="visibility: hidden;"> 
                                                <input type="text" id="num2" style="visibility: hidden;"> 
                                                <input type="text" id="suma2" style="visibility: hidden;"> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
