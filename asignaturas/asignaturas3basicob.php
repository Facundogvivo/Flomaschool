...
<head>
    ...
    <title>FlomaSchool | Asignaturas 3° basico B</title>
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Asignaturas 3° básico B</strong>
                            </div>
                            <div class="card-body" style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-success asignaturas" style="background-color: orange; color: #fff"><a href="matematicas/3basico/losNumerosHastaEl10.php">Matemáticas</a></button><br><br>
