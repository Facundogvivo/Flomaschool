...
<head>
    ...
    <title>FlomaSchool | Asignaturas 8° basico A</title>
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Asignaturas 8° básico A</strong>
                            </div>
                            <div class="card-body" style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-success asignaturas" style="background-color: orange; color: #fff"><a href="matematicas/8basico/losNumerosHastaEl10.php">Matemáticas</a></button><br><br>
