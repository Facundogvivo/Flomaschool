...
<head>
    ...
    <title>FlomaSchool | Asignaturas 7° basico B</title>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4medioa">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-bookmark"></i> &#10004;&#65039; IV Medio</a>
                        <ul class="sub-menu children dropdown-menu">
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="../conductas/conducta4mediobphp">&#127822; Conductas</a></li>
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Asignaturas 7° básico B</strong>
                            </div>
                            <div class="card-body" style="text-align: center;">
                                <button type="button" class="btn btn-primary asignaturas" style="background-color: red; color: #fff">Religión</button>
                                <button type="button" class="btn btn-primary asignaturas" style="background-color: blue; color: #fff">Inglés</button>
                                <button type="button" class="btn btn-secondary asignaturas" style="background-color: yellow; color: #fff">Música</button>
                                <button type="button" class="btn btn-danger asignaturas" style="background-color: green; color: #fff">Lenguaje</button>
                                <button type="button" class="btn btn-success asignaturas" style="background-color: orange; color: #fff"><a href="matematicas/7basico/losNumerosHastaEl10.php">Matemáticas</a></button><br><br>
                                <button type="button" class="btn btn-warning asignaturas" style="background-color: brown; color: #fff">Tópico</button>
                                <button type="button" class="btn btn-info asignaturas" style="background-color: pink; color: #fff">Educación física</button>
                                <button type="button" class="btn btn-link asignaturas" style="background-color: purple; color: #fff">Arte</button>
                                <button type="button" class="btn btn-warning asignaturas" style="background-color: black; color: #fff">Tecnología</button>
                                <button type="button" class="btn btn-secondary asignaturas" style="background-color: white; color: #000">Orientación</button>
                            </div>
                        </div><!-- /# card -->
                    </div>
