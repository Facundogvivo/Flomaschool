...
<head>
    ...
    <title>FlomaSchool | Asignaturas IV medio A</title>
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Asignaturas IV medio A</strong>
                            </div>
                            <div class="card-body" style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-success asignaturas" style="background-color: orange; color: #fff"><a href="matematicas/4medio/losNumerosHastaEl10.php">Matemáticas</a></button><br><br>
