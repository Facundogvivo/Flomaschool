...
<head>
    ...
    <title>FlomaSchool | Asignaturas I medio B</title>
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Asignaturas I medio B</strong>
                            </div>
                            <div class="card-body" style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-success asignaturas" style="background-color: orange; color: #fff"><a href="matematicas/1medio/losNumerosHastaEl10.php">Matemáticas</a></button><br><br>
