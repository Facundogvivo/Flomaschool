...
<head>
    ...
    <title>FlomaSchool | Conducta 2° basico B</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta1basicoa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta1basicob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta2basicoa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta3basicoa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta3basicob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta4basicoa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta4basicob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu5basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta5basicoa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu5basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta5basicob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu6basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta6basicoa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu6basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta6basicob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu7basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta7basicoa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu7basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta7basicob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu8basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta8basicoa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu8basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta8basicob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta1medioa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta1mediob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta2medioa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta2mediob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta3medioa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta3mediob.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta4medioa.php">&#127822; Conductas</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="conducta4mediob.php">&#127822; Conductas</a></li>
...
?>
                ...
                <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Conducta 2° básico B</strong>
                            ...
                            <div class="card-body" style="text-align: center;">
                                <table class="table" id="dataTable1" style="text-align: left">
                                    <tr>
                                        ...
                                        <td style="width: 18%">Apellido</td>
                                        <td style="width: 18%">Positivas</td>
                                        <td style="width: 18%">Negativas</td>
                                    </tr>
                                    <?php
                                    ...
                                    while ($columna = mysqli_fetch_array( $resultado2b ))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $columna['positivas'];?></td>
                                            <td><?php echo $columna['negativas'];?></td>
        ...
        <div class="modal fade" id="conducta" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
              <div class="modal-dialog modal-sm" role="document">
                  <div class="modal-content">
                    ...
                    <form action="conducta_registro.php" method="POST">
