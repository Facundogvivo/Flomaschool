...
<head>
    ...
    <title>FlomaSchool | Asistencias III medio A</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia1basicoa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia1basicob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia2basicoa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia2basicob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia3basicoa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia3basicob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia4basicoa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia4basicob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu5basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia5basicoa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu5basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia5basicob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu6basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia6basicoa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu6basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia6basicob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu7basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia7basicoa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu7basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia7basicob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu8basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia8basicoa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu8basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia8basicob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia1medioa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia1mediob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia2medioa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia2mediob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia3mediob.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia4medioa.php">&#127817; Asistencias</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="asistencia4mediob.php">&#127817; Asistencias</a></li>
                ...
                <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Asistencia III medio A</strong>
                            ...
                            <div class="card-body" style="text-align: center;">
                                <table class="table" id="dataTable1" style="text-align: left">
                                    <tr>
                                        ...
                                        <td style="width: 15%">Asistencias</td>
                                        <td style="width: 15%">Inasistencias</td>
                                        <td style="width: 15%">Atrasos</td>
                                        <td style="width: 15%">Reuniones</td>
                                    </tr>
                                    <?php
                                    ...
                                    {
                                    if($usuarioActivoNombre == $columna['nombre'] . " " . $columna['apellido'] ){
                                        ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $columna['asistencias'];?></td>
                                            <td><?php echo $columna['inasistencias'];?></td>
                                            <td><?php echo $columna['atrasos'];?></td>
                                            <td><?php echo $columna['reuniones'];?></td>
                                        </tr>
                                        <?php
                                    }                               
                                    if($usuarioActivoNombre == "facundo gonzalez vivo" ){
                                        ?>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="smallmodalLabel">Asistencias</h5>
                    ...
                    <form action="calificacion_registro.php" method="POST">
                        <div class="modal-body"> 
                            ...
                            <label for="txt_alumno" class="form-label">Alumno(a)</label>
                                ...
                                <label for="txt_asistencia" class="form-label">Asistencias</label>
                                <select class="form-control text-uppercase" id="txt_asistencia" name="txt_asistencia">
                                    <option value="0" style="display:none;">Seleccionar</option>
                                ...
                                <label for="txt_fecha_asistencia" class="form-label">Fecha</label>
                                <input type="date" class="form-control text-uppercase" id="txt_fecha_asistencia" name="txt_fecha_asistencia">
                            </div>
