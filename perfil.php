...
<head>
    ...
    <title>FlomaSchool | Perfil</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Perfil de 
                                    <?php
                                                include("conexion.php");
                            ...
                            <div class="card-body card-block">
                                <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">Rut</label></div>
                                                ...
                                                while ($columna1 = mysqli_fetch_array( $resultado ))
                    {
                        if($usuarioActivo == $columna1['rut']){
                            ...
                            echo $columna1['nombre'];
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">Apellido</label></div>
                                        <div class="col-12 col-md-9">
                                            <p class="form-control-static">
                                            <?php
                                            include("conexion.php");
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">Contraseña</label></div>
                                        <div class="col-12 col-md-9">
                                        <p class="form-control-static">
                                            <?php
                                            include("conexion.php");
