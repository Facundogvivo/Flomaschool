...
<head>
    ...
    <title>FlomaSchool | Calificaciones III medio B</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones1basicoa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones1basicob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones2basicoa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones2basicob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones3basicoa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones3basicob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones4basicoa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones4basicob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu5basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones5basicoa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu5basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones5basicob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu6basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones6basicoa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu6basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones6basicob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu7basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones7basicoa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu7basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones7basicob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu8basicoa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones8basicoa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu8basicob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones8basicob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones1medioa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu1mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones1mediob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones2medioa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu2mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones2mediob.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu3medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones3medioa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4medioa">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones4medioa.php">&#127824; Calificaciones</a></li>
                    ...
                    <li class="menu-item-has-children dropdown" hidden id="menu4mediob">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="calificaciones4mediob.php">&#127824; Calificaciones</a></li>
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Calificaciones III medio B</strong>
                                <button type="button" class="btn btn-success btn-sm" id="agregar" style="float: right;" hidden><i class="fa fa-plus" data-toggle="modal" data-target="#smallmodal"></i>&nbsp;</button>
                            </div>
                            <div class="card-body" style="text-align: center;">
                                <table class="table" id="dataTable1" style="text-align: left">
                                    <tr>
                                        <td>Id</td>
                                        <td>Nombre</td>
                                        <td>Apellido</td>
                                        ...
                                        <td>#3</td>
                                        <td>#4</td>
                                        <td><span class="over">X</span><sub>1</sub></td>
                                        <td>#5</td>
                                        <td>#6</td>
                                        <td>#7</td>
                                        <td>#8</td>
                                        <td><span class="over">X</span><sub>2</sub></td>
                                        <td><span class="over">X</span><sub>total</sub></td>
                                    </tr>
                                    <?php
                                    ...
                                    while ($columna1 = mysqli_fetch_array( $resultado ))
                                    {
                                        if($usuarioActivo == $columna1['rut']){
                                            ...
                                            $usuarioActivoNombre = $columna1['nombre'] . " " . $columna1['apellido'];
                                    ...
                                    {
                                    if($columna['nombre'] . " " . $columna['apellido'] == $usuarioActivoNombre){
                                        ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $columna['nota1'];?></td>
                                            <td><?php echo $columna['nota2'];?></td>
                                            <td><?php echo $columna['nota3'];?></td>
                                            <td><?php echo $columna['nota4'];?></td>
                                            <td><?php 
                                            $cantidad1=0;
                                            if($columna['nota1']== 0){$cantidad1 = $cantidad1 + 1;}else{$cantidad1 = $cantidad1 + 0;};
                                            if($columna['nota2']== 0){$cantidad1 = $cantidad1 + 1;}else{$cantidad1 = $cantidad1 + 0;};
                                            if($columna['nota3']== 0){$cantidad1 = $cantidad1 + 1;}else{$cantidad1 = $cantidad1 + 0;};
                                            if($columna['nota4']== 0){$cantidad1 = $cantidad1 + 1;}else{$cantidad1 = $cantidad1 + 0;};
                                            echo ($columna['nota1']+$columna['nota2']+$columna['nota3']+$columna['nota4'])/$cantidad1;?></td>
                                            <td><?php echo $columna['nota5'];?></td>
                                            <td><?php echo $columna['nota6'];?></td>
                                            <td><?php echo $columna['nota7'];?></td>
                                            <td><?php echo $columna['nota8'];?></td>
                                            <td><?php 
                                            $cantidad2=0;
                                            if($columna['nota5']== 0){$cantidad2 = $cantidad2 + 1;}else{$cantidad2 = $cantidad2 + 0;};
                                            if($columna['nota6']== 0){$cantidad2 = $cantidad2 + 1;}else{$cantidad2 = $cantidad2 + 0;};
                                            if($columna['nota7']== 0){$cantidad2 = $cantidad2 + 1;}else{$cantidad2 = $cantidad2 + 0;};
                                            if($columna['nota8']== 0){$cantidad2 = $cantidad2 + 1;}else{$cantidad2 = $cantidad2 + 0;};
                                            echo ($columna['nota5']+$columna['nota6']+$columna['nota7']+$columna['nota8'])/$cantidad2;?></td>
                                            <td><?php 
                                            echo ((($columna['nota1']+$columna['nota2']+$columna['nota3']+$columna['nota4'])/$cantidad1)+(($columna['nota5']+$columna['nota6']+$columna['nota7']+$columna['nota8'])/$cantidad2)/2);?></td>
                                        </tr>
                                        <?php
                                        }
                                    }
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="smallmodalLabel">Agregar nota</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    <form action="calificacion_registro.php" method="POST">
                        <div class="modal-body"> 
                            <div class="card-body" style="text-align: center;">
                                    <label for="txt_alumno" class="form-label">Alumno(a)</label>
                                    <select class="form-control text-uppercase" id="txt_alumno" name="txt_alumno">
                                        ...
                                        <?php
                                            ...
                                            while ($columna = mysqli_fetch_array( $resultadoIIIb ))
                                            {
                                                ...
                                                ?>
                                                    ...
                                                    <option><?php echo $columna['nombre'] . " " . $columna['apellido']; ?></option>
                                                <?php
                                    ...
                                    <label for="txt_lugar" class="form-label">Nota</label>
                                    <select class="form-control text-uppercase" id="txt_lugar" name="txt_lugar">
                                        <option value="0" style="display:none;">Seleccionar</option>
                                        ...
                                        <option value="nota6">#6</option>
                                        <option value="nota7">#7</option>
                                        <option value="nota8">#8</option>
                                    </select>
                                        </br>                                    
                                    <label for="txt_nota" class="form-label">Valor</label>
                                    <input type="text" class="form-control text-uppercase" id="txt_nota" name="txt_nota">
                                </div>
